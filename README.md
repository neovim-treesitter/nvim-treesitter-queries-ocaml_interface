# nvim-treesitter-queries-ocaml_interface

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocaml_interface/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocaml_interface/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ocaml_interface**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ocaml_interface",
...
- [ ] Changes are scoped to `ocaml_interface` — do not include files for other languages
